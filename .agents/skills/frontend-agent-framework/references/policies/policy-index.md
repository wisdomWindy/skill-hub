...
| `spec` | `source-grounding.md`, `spec-constraints.md`, `design-patterns.md`, `doc-writing.md` | `workflow-efficiency.md` when compact artifact depth or context breadth is being chosen, plus all code-quality, architecture, styling, API, TypeScript, testing, intent, and human-review-readiness policies that affect the scoped work |
| `plan` | `source-grounding.md`, `testing.md`, `design-patterns.md`, `doc-writing.md`, `plan-executable-contract.md` | `workflow-efficiency.md` when compact tasking, scoped verification, or parallelism is being chosen, plus the same applicable policy set approved in `spec`, plus `code-review-checklist.md` and `human-review-readiness.md` for code-changing work and `code-graph.md` when impact analysis is needed |
| `execute` | `source-grounding.md`, `clean-code.md` | `workflow-efficiency.md` when choosing context breadth or command scope, policies named by the approved `spec` / `plan`, `code-review-checklist.md` and `human-review-readiness.md` for code-changing work, and any policy triggered by implementation facts discovered during execution |
| `verify` | `constraint-model.md`, `testing.md`, `source-grounding.md`, `design-patterns.md` | `workflow-efficiency.md` when choosing scoped verification commands, plus every policy with an applicable verification verdict in `constraint-model.md`, including `human-review-readiness.md` for code-changing work |
| `review` | `constraint-model.md`, `clean-code.md`, `source-grounding.md`, `design-patterns.md` | `workflow-efficiency.md` when using compact changed-hunk review, plus every policy with an applicable review verdict in `constraint-model.md`, including `code-review-checklist.md` and `human-review-readiness.md` for code-changing work |
