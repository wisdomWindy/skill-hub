...
<template>
  ...
  >
    ...
    <h2 id="version-history-title" class="mt-[14px] mb-3 text-xl">版本历史</h2>
    <div class="markdown-body text-[var(--text-muted)] [&_ul]:pl-[18px]" v-html="props.renderedChangelog" />
  </section>
</template>
